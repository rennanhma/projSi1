...
public class Easy {
	...
	public String responderSugestaoPontoEncontro(String idSessao,
		...
		return sistema.responderSugestaoPontoEncontro(idSessao, idCarona, idSugestao,
				pontos);
	}
	...
	public String aceitarSolicitacaoPontoEncontro(String idSessao,
		...
		return sistema.aceitarSolicitacaoPontoEncontro(idSessao, idSolicitacao);
	}

	public String aceitarSolicitacao(String idSessao, String idSolicitacao)
			throws Exception {
		return sistema.aceitarSolicitacao(idSessao, idSolicitacao);
	}
