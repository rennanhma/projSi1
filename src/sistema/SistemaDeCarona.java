...
public class SistemaDeCarona {
	...
	public void criarUsuario(String login, String senha, String nome, String endereco, String email) throws Exception {
		 ...
		 Perfil	perfil = new Perfil(nome, endereco, email, login);//criar perfil do usuario
...
public String localizarCarona(String idSessao, String origem,String destino) throws Exception {
		...
		if (sessao.getLogin().equals(carona.getDonoDaCarona().getLogin())) { // verifica se o login de quem ta logado eh igual ao do dono da carona
			for (Sugestao sugestao : carona.getSugestoes()) {
				...
				//	sugestao.addResposta(sugestao, resp);
					sugestao.addResposta(resp); // adiciona em um mapa a sugestao e a resposta dessa sugestao
				}
	...
	public String solicitarVagaPontoEncontro (String idSessao, String idCarona, String ponto) throws Exception{
                ...
                for (Sugestao sugestao : carona.getSugestoes()) {
	                  for (Resposta resposta : sugestao.getlistaDeResposta()) {
	                	  if (resposta.getPontos().contains(ponto)) { // verifica no mapa de sugestoes e respostas se alguma resposta contem o ponto desejado para a carona
	...
	public void excecaoDesistirSolicitacao(boolean desistirSolicitacao) throws Exception{
