...
// User04
	...
	/**
	 * Busca solicitacao pelo IDSolicitacao
	 * 
	 * @param idSolicitacao
	 * @return
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		sc.criarUsuario("rennanhm", "senha1", "Renna Henrique",
				"Rua tal do tal", "rennanhm@gmail.com");
		sc.criarUsuario("bill", "billsenha", "Biludo", "rua macaiba",
				"bil@gmail.com");
		String idCarona = sc.cadastrarCarona(
				sc.abrirSessao("rennanhm", "senha1"), "origem1", "destino1",
				"25/07/2012", "13:00", "3");
		sc.encerrarSessao("rennanhm");
		String soliciatacao = sc.solicitarVagaPontoEncontro(
				sc.abrirSessao("bill", "billsenha"), idCarona, "Açude");
		System.out.println(sc.getAtributoSolicitacao(soliciatacao,
				"Dono da solicitacao"));
